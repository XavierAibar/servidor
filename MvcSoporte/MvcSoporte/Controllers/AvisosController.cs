...
namespace MvcSoporte.Controllers
{
    public class AvisosController : Controller
    {
        ...
        // GET: Avisos
        public async Task<IActionResult> Index(string strCadenaBusqueda, string busquedaActual, int? intTipoAveriaId,
            int? tipoAveriaIdActual, int? pageNumber)
        {
           ...
           .Include(a => a.TipoAveria);
            ...
            // return View(await avisos.AsNoTracking().ToListAsync());            // var mvcSoporteContexto = _context.Avisos.Include(a => a.Empleado).Include(a => a.Equipo).Include(a => a.TipoAveria);
