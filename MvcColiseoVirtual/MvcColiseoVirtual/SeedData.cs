...
namespace MvcColiseoVirtual
{
    public class SeedData
    {
        ...
        private static async Task CrearAdminAsync(UserManager<IdentityUser> userManager)
        {
            ...
            userResult = await userManager.CreateAsync(testAdmin, admPasswd);// Se agrega el rol "Administrador" al administrador predeterminado
